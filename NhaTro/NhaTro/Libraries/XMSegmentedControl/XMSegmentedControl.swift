...
//  NhaTro
//
//  Created by HOANGHUNG on 9/2/17.
...
open class XMSegmentedControl: UIView {
    ...
    open func update() {
        func addSegments(startingPosition starting: CGFloat, sections: Int, width: CGFloat, height: CGFloat) {
            for i in 0..<sections {
                ...
                case .hybridVertical:
                    ...
                    guard let halfSizeFont = UIFont(name: font.fontName, size: font.pointSize / 2.0) else { return }
        ...
        func addHighlightView(startingPosition starting: CGFloat, width: CGFloat) {
            ...
            highlightView.layer.cornerRadius = self.layer.cornerRadius
